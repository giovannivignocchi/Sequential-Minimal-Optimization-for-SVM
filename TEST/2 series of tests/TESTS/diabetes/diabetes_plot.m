...
load('C:\Users\giova\Dropbox\documenti\MATLAB\Sequential Minimal Optimization for SVM\TEST\on real dataset\TESTS RESULTS\GRID SERACH\DIABETES\gridSearch.mat');

C = [2^-5, 2^-3, 2, 2^7, 2^9, 2^15]';
